  ...
  <header>
    <nav>
      ...
      <ul>
        ...
        <li class="header_btn pcInnerText header_animal">
        ...
        <li class="header_btn pcInnerText header_vote">
        ...
        <li class="header_btn pcInnerText header_school">
        ...
        <li class="header_btn pcInnerText header_ticket">
